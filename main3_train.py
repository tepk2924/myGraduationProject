...
if __name__ == '__main__':
    ...
    train_dataset = DataGenerator(input("Train Scene이 들어있는 폴더의 디렉토리 입력 : "), grasp_root_folder, train_config["BATCH_SIZE"], train_config["RAW_NUM_POINTS"], threshold=0.05, search_radius=0.003)
    validation_dataset = DataGenerator(input("Validation Scene이 들어있는 폴더의 디렉토리 입력 : "), grasp_root_folder, train_config["BATCH_SIZE"], train_config["RAW_NUM_POINTS"], threshold=0.05, search_radius=0.003)
